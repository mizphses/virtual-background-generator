...
def create_image(logo_image, name, status, has_qr, qr):
  # 画像の生成
  ...
  font = ImageFont.truetype('fonts/jp-semi.ttf', 70)
  draw.text((70, int(base_image.size[1] / 6)), name, (0, 0, 0), font=font)
  font = ImageFont.truetype('fonts/jp-semi.ttf', 40)
  draw.text((70, int(base_image.size[1] / 6) + 90), status, (0, 0, 0), font=font)
  font = ImageFont.truetype('fonts/jp-semi.ttf', 20)
